...
from ProfAnalyzer import ProfAnalyzer
...
class Runner:
    ...
    def analyze_company(
        ...
        summary = [
            ...
            f"Net Income: ${company.net_income:,.0f}",
            f"EBITDA: ${company.ebitda:,.0f}",
            f"Gross Profit: ${company.gross_profit:,.0f}",
            f"Net Income Margin: {company_margin:.4%}",
            f"Working Capital: ${cash.workingCapital:,.0f}",
            f"Operating Cash Flow: ${cash.operatingCF:,.0f}",
            f"Free Cash Flow: ${cash.fcf:,.0f}"
        ]
        ...
        # A company at either end of the sorted ranking has no neighbour on
        # one side, so do not subscript a missing peer.
        revLeftPeerRevenue = None
        revRightPeerRevenue = None
        ...
        revLeftPeerTitle = ""
        revLeftPeerRevenueText = ""

        revRightPeerTitle = ""
        revRightPeerRevenueText = ""
        ...
        if ranking1["left_peer"] is not None:
            ...
            revLeftPeerRevenue = ranking1["left_peer"]["Revenue"]
        ...
        if ranking1["right_peer"] is not None:
            ...
            revRightPeerRevenue = ranking1["right_peer"]["Revenue"]
        
        visualizations = DataVisualization()
        visualizations.plotRevenueGraph(name, company.revenue, revTitle, revRank,
                                        revLeftPeerTitle, revLeftPeerRevenue,
                                        revRightPeerTitle, revRightPeerRevenue)
        
        ranking2 = ranking_engine.rank_by_netIncome(
            peers_df,
            company.net_income
        )
        nILeftPeerNetIncome = None
        nIRightPeerNetIncome = None
        ...
        nILeftPeerTitle = ""
        nILeftPeerNetIncomeText = ""

        nIRightPeerTitle = ""
        nIRightPeerNetIncomeText = ""
        ...
        if ranking2["left_peer"] is not None:
            ...
            nILeftPeerNetIncome = ranking2["left_peer"]["Net Income"]
        ...
        if ranking2["right_peer"] is not None:
            ...
            nIRightPeerNetIncome = ranking2["right_peer"]["Net Income"]
            
        visualizations.plotNetIncomeGraph(name, company.net_income, nITitle, nIRank,
                                          nILeftPeerTitle, nILeftPeerNetIncome,
                                          nIRightPeerTitle, nIRightPeerNetIncome)
        ...
        ebLeftPeerEBITDA = None
        ebRightPeerEBITDA = None
        ...
        ebLeftPeerTitle = ""
        ebLeftPeerEBITDAText = ""

        ebRightPeerTitle = ""
        ebRightPeerEBITDAText = ""
        ...
        if ranking3["left_peer"] is not None:
            ...
            ebLeftPeerEBITDA = ranking3["left_peer"]["EBITDA"]
        ...
        if ranking3["right_peer"] is not None:
            ...
            ebRightPeerEBITDA = ranking3["right_peer"]["EBITDA"]
        
        visualizations.plotEBITDAGraph(
            name, company.ebitda, ebTitle,
            ebRank, ebLeftPeerTitle, ebLeftPeerEBITDA,
            ebRightPeerTitle, ebRightPeerEBITDA
        )

        prof_analyzer = ProfAnalyzer()
        rev_analysis = prof_analyzer.analyze_revenue(company.revenue, revRightPeerRevenue)
        ...
        explanations = cash_analyzer.explain_cash_flow(cash_ctx)
        ...
        return {
            ...
            "revenue":
            {
                ...
                "lpRevenue": revLeftPeerRevenueText,
                "rpTitle": revRightPeerTitle,
                "rpRevenue": revRightPeerRevenueText,
            },
            ...
            "net_income":
            {
                ...
                "lpNetIncome": nILeftPeerNetIncomeText,
                "rpTitle": nIRightPeerTitle,
                "rpNetIncome": nIRightPeerNetIncomeText,
            },
            "ebitda":
            {
                "title": ebTitle,
                ...
                "lpEBITDA": ebLeftPeerEBITDAText,
                "rpTitle": ebRightPeerTitle,
                "rpEBITDA": ebRightPeerEBITDAText,
                
            },
            "cash_metrics": cash_ctx,
            "cash_flow_analyzer": explanations,
